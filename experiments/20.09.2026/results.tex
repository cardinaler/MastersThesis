...
Всего генерируется 20000 элементов для обучающей выборки. 
...
\newpage
\subsection{Пример 1}
$f(x) = A e^{\frac{(x - \mu)^2}{\sigma^2}}$, где $A = 7, \ \sigma^2 = \frac{1}{3}, \ \mu = 3$.
\begin{figure}[htbp]
    \centering
...
\newpage
\subsection{Пример 2}
$f(x) = A e^{\frac{(x - \mu)^2}{\sigma^2}}$, где $A = 8, \ \sigma^2 = \frac{1}{5}, \ \mu = 6$.
\begin{figure}[htbp]
    \centering
